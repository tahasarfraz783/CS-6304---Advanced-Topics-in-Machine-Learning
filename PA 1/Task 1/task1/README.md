...
The official STL-10 files are stored locally in task1/data/stl10_binary.
...
The new workflow only writes inside its own task1/results.
...
Open task1/scripts/run_task1.ipynb. Select STEP in the final cell and run all cells.
